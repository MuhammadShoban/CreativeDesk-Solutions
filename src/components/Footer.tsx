  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        message: `Please subscribe this user to the newsletter list.\nEmail: ${newsletterEmail}`,
        botcheck: '',
      };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[1.6fr_1fr_1fr_1.1fr_1.5fr] gap-8 sm:gap-10 pb-10 sm:pb-14 border-b border-white/10">
          ...
          <div className="flex flex-col gap-4">
            ...
            {newsletterStatus === 'success' ? (
              <div className="flex flex-col gap-2.5 p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 animate-fade-in">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-jakarta font-bold text-sm text-white">Subscribed!</span>
                </div>
                <p className="text-xs text-slate-400 leading-normal">
                  Thank you! You've successfully subscribed to our quarterly newsletter.
                </p>
              </div>
            ) : (
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col gap-2">
                <div className="flex flex-col xs:flex-row gap-2">
                  ...
                  <button
                    type="submit"
                    disabled={newsletterStatus === 'loading'}
                    className="btn-primary btn-sm flex-shrink-0 whitespace-nowrap disabled:opacity-75 disabled:cursor-not-allowed"
                  >
                ...
                {newsletterStatus === 'error' && (
                  <p className="text-xs text-rose-400 font-semibold px-1 mt-1">
                    {newsletterError}
                  </p>
                )}
              </form>
